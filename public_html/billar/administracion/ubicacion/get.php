...
$rs = $conexion->mysqli->query("select count(*) from ubicacion");
...
$resultado_consulta = $conexion->mysqli->query("SELECT
u.id,
u.nombre,
p.id as 'id_precio',
p.nombre as 'tipo_precio'
from ubicacion as u join precio as p on u.tipo = p.id
ORDER BY $sort $order
");
