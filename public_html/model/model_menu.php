...
class menu extends procesos_bd {
...
WHERE grupo.id = '" . $_SESSION['grupo'] . "' ";
    $resultado = consulta_bd::consulta($sql1);
...
WHERE privilegio.id_grupo = '$row->id'";
      $resultado_2 = consulta_bd::consulta($sql2);
...
WHERE id_menu = '$row_2->id_menu'";
        $resultado_3 = consulta_bd::consulta($sql3);
...
WHERE submenu_2.id_submenu_1 = '$row_3->id_submenu_1' ";
          $resultado_4 = consulta_bd::consulta($sql4);
